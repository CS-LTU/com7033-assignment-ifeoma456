#!/usr/bin/env python3
"""
RBAC Test Results Summary Report
Hospital Management System - Role-Based Access Control Test Suite
"""
...
print(report.format(date=datetime.datetime.now().strftime("%Y-%m-%d %H:%M:%S")))

# Save to file
with open('/Users/macsmouse/com7033-assignment-ifeoma456/RBAC_TEST_RESULTS.md', 'w') as f:
    f.write(report.format(date=datetime.datetime.now().strftime("%Y-%m-%d %H:%M:%S")))

print("\nReport saved to: RBAC_TEST_RESULTS.md")
